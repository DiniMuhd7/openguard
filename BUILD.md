...
### Step 3 — Install NATS Server
```bash
# Check the latest release at https://github.com/nats-io/nats-server/releases
# Replace <version> with the latest version (e.g. v2.10.24)
...
Change the listen address: `export LISTEN_ADDR=":9080"` (or use `$env:LISTEN_ADDR=":9080"` on Windows).
